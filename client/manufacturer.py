...
def fun2():
    ...
    k= giveToDistributor('A',distributor, medicine)
    if(k=="COMMITTED"):
        
        return render_template('alert.html',command="SENT THE REQUIRED BATCH SUCCESSFULLY",port="5000")
    else:
